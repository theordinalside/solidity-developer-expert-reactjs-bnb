      ...
      >
        ...
        >
          <div
            ...
            style={{ width: "auto" }}
            onClick={() => {
              window.open(`https://openordex.org/`, "_blank");
            }}
          >
            <img src="images/ordinal.png" alt="" />
            <p>Open Inscription </p>
          </div>
          <div
            className="desktop-icon1"
            style={{ width: "auto" }}
            onClick={() => {
              window.open(`https://ordswap.io/`, "_blank");
            }}
          >
            <img src="images/ord.ico" alt="" style={{ width: "32px" }} />
            <p>Ordswap </p>
          </div>
          <div
            className="desktop-icon1"
            style={{ width: "auto" }}
            onClick={() => {
              window.open(`https://ordinalswallet.com/`, "_blank");
            }}
          >
            <img src="images/ord_wallet.svg" alt="" style={{ width: "32px" }} />
            <p>Ordinals Wallet </p>
          </div>
        </div>
      </Window>
