      ...
      >
        ...
        >
          <div
            ...
            style={{ width: "auto" }}
            onClick={() => {
              window.open(`https://ordinals.com/`, "_blank");
            }}
          >
            <img
              src="images/ordinals_icon.png"
              alt=""
              style={{ width: "32px" }}
            />
            <p>Ordinals </p>
          ...
          <div
            ...
            style={{ width: "auto" }}
            onClick={() => {
              window.open(`https://ordinals.hiro.so/`, "_blank");
            }}
          >
            <img src="images/hire.png" alt="" style={{ width: "32px" }} />
            <p>Hiro Ordinals </p>
          </div>
        </div>
      </Window>
