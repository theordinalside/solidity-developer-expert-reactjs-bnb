...
var r = (function () {
  function t(t) {
    ...
    "Dark" === this._options.theme && // eslint-disable-line
  ...
  return (
    ...
    (t.prototype.remove = function () {
      window.removeEventListener("resize", this._onWindowResize), // eslint-disable-line
    ...
    (t.prototype.applyOverrides = function (t) {
      (this._options = e(this._options, { overrides: t })), // eslint-disable-line
    ...
    (t.prototype._create = function () {
      ...
      (o.innerHTML = e), (this._iFrame = o.querySelector("#" + this._id)); // eslint-disable-line
      var n = this._iFrame;
      (this._options.autosize || this._options.fullscreen) && // eslint-disable-line
        ((n.style.width = "100%"),
        this._options.fullscreen || (n.style.height = "100%")), // eslint-disable-line
        window.addEventListener("resize", this._onWindowResize),
        this._onWindowResize(),
        (this._innerWindowLoaded = new Promise(function (t) {
          var e = function () {
            n.removeEventListener("load", e, !1), t(); // eslint-disable-line
          };
    ...
    (t.prototype._render = function () {
      ...
      if (
        ...
        (t[this._id].chartContent = { json: this._options.saved_data }), // eslint-disable-line
...
(window.TradingView = window.TradingView || {}), // eslint-disable-line
